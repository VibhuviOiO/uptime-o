    ...
    <div>
      ...
      <div className="table-responsive">
        {scheduleList && scheduleList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('includeResponseBody')}>
                  Include Response Body <FontAwesomeIcon icon={getSortIconByFieldName('includeResponseBody')} />
                </th>
                <th className="hand" onClick={sort('thresholdsWarning')}>
                  Thresholds Warning <FontAwesomeIcon icon={getSortIconByFieldName('thresholdsWarning')} />
                </th>
                <th className="hand" onClick={sort('thresholdsCritical')}>
                  Thresholds Critical <FontAwesomeIcon icon={getSortIconByFieldName('thresholdsCritical')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && <div className="alert alert-warning">No Schedules found</div>
        )}
      </div>
      {totalItems ? (
