...
import reducer, {
  ...
  reset,
  updateEntity,
} from './datacenter-monitor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATACENTERMONITOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DATACENTERMONITOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DATACENTERMONITOR actions', async () => {
      const arg = { id: 28104 };
    ...
    it('dispatches UPDATE_DATACENTERMONITOR actions', async () => {
      const arg = { id: 28104 };
    ...
    it('dispatches PARTIAL_UPDATE_DATACENTERMONITOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DATACENTERMONITOR actions', async () => {
      const arg = 42666;
