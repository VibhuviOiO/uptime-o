...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIMONITOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APIMONITOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APIMONITOR actions', async () => {
      const arg = { id: 18056 };
    ...
    it('dispatches UPDATE_APIMONITOR actions', async () => {
      const arg = { id: 18056 };
    ...
    it('dispatches PARTIAL_UPDATE_APIMONITOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APIMONITOR actions', async () => {
      const arg = 42666;
