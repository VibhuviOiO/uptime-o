...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APIHEARTBEAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APIHEARTBEAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APIHEARTBEAT actions', async () => {
      const arg = { id: 975 };
    ...
    it('dispatches UPDATE_APIHEARTBEAT actions', async () => {
      const arg = { id: 975 };
    ...
    it('dispatches PARTIAL_UPDATE_APIHEARTBEAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APIHEARTBEAT actions', async () => {
      const arg = 42666;
