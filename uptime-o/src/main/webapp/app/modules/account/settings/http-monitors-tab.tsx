...
import { faPencil, faTrash, faGlobe, faPlus, faCode, faBuilding } from '@fortawesome/free-solid-svg-icons';
          ...
          <tbody>
            {monitors.map((monitor, i) => (
              <tr key={`entity-${i}`}>
                ...
                <td>
                  {monitor.headers ? (
                    <Button color="link" size="sm" onClick={() => handleViewHeaders(monitor)} title="View Headers" style={{ padding: 0 }}>
...
export default HttpMonitorsTab;
