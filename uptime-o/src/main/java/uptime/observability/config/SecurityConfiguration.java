        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/files/**")).permitAll()
                    .requestMatchers(mvc.pattern("/api/public/brandings/active")).permitAll()
                    .requestMatchers(mvc.pattern("/api/public/status")).permitAll()
                    .requestMatchers(mvc.pattern("/api/public/status-page/**")).permitAll()
                    .requestMatchers(mvc.pattern("/api/public/monitors/**")).permitAll()
                    .requestMatchers(mvc.pattern("/api/public/heartbeats")).permitAll()
