...
/**
 * REST controller for managing {@link uptime.observability.domain.Schedule}.
 */
@RestController
...
public class ScheduleResource {
    ...
    public ResponseEntity<ScheduleDTO> createSchedule(@Valid @RequestBody ScheduleDTO scheduleDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/schedules/" + scheduleDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, scheduleDTO.getId().toString()))
            .body(scheduleDTO);
    }
