...
public class HttpHeartbeatAsserts {
     ...
     */
    public static void assertApiHeartbeatAllPropertiesEquals(HttpHeartbeat expected, HttpHeartbeat actual) {
     ...
     * @param actual the actual entity
     */
    public static void assertApiHeartbeatAllUpdatablePropertiesEquals(HttpHeartbeat expected, HttpHeartbeat actual) {
     ...
     * @param actual the actual entity
     */
    public static void assertApiHeartbeatAutoGeneratedPropertiesEquals(HttpHeartbeat expected, HttpHeartbeat actual) {
        assertThat(actual)
     ...
     * @param actual the actual entity
     */
    public static void assertApiHeartbeatUpdatableFieldsEquals(HttpHeartbeat expected, HttpHeartbeat actual) {
        assertThat(actual)
     ...
     * @param actual the actual entity
     */
    public static void assertApiHeartbeatUpdatableRelationshipsEquals(HttpHeartbeat expected, HttpHeartbeat actual) {
        assertThat(actual)
